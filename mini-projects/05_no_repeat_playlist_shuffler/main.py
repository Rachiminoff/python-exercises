"""
Mini Project #5: No-Repeat Playlist Shuffler 🎵

Shuffle a playlist so nothing repeats until everything's played.

Build one program that meets all of these requirements:
